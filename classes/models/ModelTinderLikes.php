...
class ModelTinderLikes {
    ...
    public function create() {
        $sql = "CREATE TABLE IF NOT EXISTS $this->table_name (" .
                ...
                "email_user_likes VARCHAR(50) NOT NULL," .
    ...
    public function insert($email_user, $email_user_likes) {
        $row = [
            'email_user' => $email_user,
            'email_user_likes' => $email_user_likes
        ];
    ...
    public function delete($email_user, $email_user_likes) {
        $sql = strtr('DELETE FROM @table WHERE @column_user_with_bind AND @column_user_viewed_with_bind;', [
            ...
            '@column_user_viewed_with_bind' => SQLBuilder::columnEqualBind('email_user_likes')
        ]);
